...
%        x_opt = Newtons_method(grad_i, hess_i, x_i, 1e-5, 20); %% -> succeeded to converge
        x_opt = gradient_descent(grad_i, x_i, 1e-5, 50);
        x = [x; x_opt];
